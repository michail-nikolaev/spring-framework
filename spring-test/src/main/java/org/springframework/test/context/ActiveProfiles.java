...
public @interface ActiveProfiles {
	 ...
	 * with {@link #profiles} either {@link #resolver}, but it may be used
	 ...
	 *
	 * <p>This attribute may <strong>not</strong> be used in conjunction
	 * with {@link #value} either {@link #resolver}, but it may be used <em>instead</em>
	 * of {@link #value}.
	 */
	 ...
	 *
	 * <p>This attribute may <strong>not</strong> be used in conjunction
	 * with {@link #value} either {@link #profiles}, but it may be used <em>instead</em>
	 * of them.
	 *
	 * @since 3.2.2
	 * @see ActiveProfilesResolver
